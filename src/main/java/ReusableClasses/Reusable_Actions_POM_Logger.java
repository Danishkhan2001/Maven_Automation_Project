...
public class Reusable_Actions_POM_Logger {
    ...
    public static void submitActions(WebDriver driver, WebElement xpath, ExtentTest logger, String elementName){
        WebDriverWait wait = new WebDriverWait(driver, to);
        try {
            WebElement element = wait.until(ExpectedConditions.visibilityOf(xpath));
            element.submit();
    ...
    public static void sendKeysActions(WebDriver driver, WebElement xpath, String uservalue,ExtentTest logger, String elementName){
        WebDriverWait wait = new WebDriverWait(driver, to);
        try {
            WebElement element = wait.until(ExpectedConditions.visibilityOf(xpath));
            element.click();
    ...
    public static String getTextActions(WebDriver driver, WebElement xpath, ExtentTest logger,String elementName){
        WebDriverWait wait = new WebDriverWait(driver, to);
        String result = null;
        try {
            WebElement element = wait.until(ExpectedConditions.visibilityOf(xpath));
