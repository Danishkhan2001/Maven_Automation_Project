...
import ReusableClasses.Reusable_Actions_Logger;
...
public class Google_Search_With_Reusable_Annotations_Report_HTML extends Reusable_Annotations_Class {
    ...
    public void SearchForKeyword(){
        ...
        Reusable_Actions_Logger.sendKeysActions(driver,"//*[@name='q']","BMW",logger,"Search Field");
        //submit the go button
        Reusable_Actions_Logger.submitActions(driver,"//*[@name='btnK']",logger,"Google Search Button");
    ...
    public void CaptureSearchNumber(){
        ...
        String result = Reusable_Actions_Logger.getTextActions(driver,"//*[@id='result-stats']",logger,"Search Result Text");
